...
export default function BasicTables() {
  ...
  const checkRole = AuthUser?.role.name !== "Admin" ? "grey" : "currentColor";
              ...
              >
                ...
                <td class="px-6 py-4">
                  <button
                    ...
                    onClick={() =>
                      handleToggleUserStatus(user.id, user?.is_activated)
                    }
                  >
                    {user?.is_activated ? (
                      <span className={`flex gap-1 items-center`}>
                        <Deactivate stroke={checkRole} />
                        <p className={` ${checkRole}`}>Activate</p>
                      </span>
                    ) : (
                      <span className={`flex gap-1 items-center `}>
                        <Activate stroke={checkRole} />
                        <p className={` ${checkRole}`}>Deactivate</p>
                      </span>
                    )}
                  </button>
                </td>
