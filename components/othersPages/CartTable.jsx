...
const CartTable = ({
  ...
  const handleQuantityChange = async (
    ...
    try {
      await updateQuantity(id, condition, basePrice, discount);
      await fetchCartData();
                ...
                >
                  ...
                  <td className="px-3 sm:px-4 py-4 align-middle">
                    <div className="flex flex-col h-full w-full max-w-xs sm:max-w-none mx-auto">
                        ...
                        {elm.discount > 0 && (
                          <div className="flex justify-between items-center mt-1 pt-1 border-t border-gray-200">
                            ...
                            <span className="text-red-600 font-medium">
                              -
                              {(
                                (basePrice * elm.quantity * elm.discount) /
                                100
                              ).toFixed(2)}{" "}
                              euro
                            </span>
                      ...
                      {/* Subtotal with discount - shown if discount exists */}
                      {elm.discount > 0 && (
                        <div className="flex justify-between items-center bg-gray-100 p-2 rounded-md shadow-sm text-xs mb-2">
                          <span className="text-gray-600">
            ...
            >
              ...
              <div className="p-4 bg-blue-50">
                ...
                <div className="bg-white rounded-lg shadow-sm p-3 mb-3">
                  <h6 className="text-sm font-semibold text-gray-700 mb-2 border-b pb-1">
                    Price Breakdown
                  </h6>
                ...
                {hasExtraTaxes && (
                  <div className="bg-white rounded-lg shadow-sm p-3 mb-3">
                    <h6 className="text-sm font-semibold text-blue-700 mb-2 border-b border-blue-100 pb-1">
                      Extra Charges
                    </h6>
                    ...
                    {Object.entries(extraTaxFields).map(
                      ([fieldName, field]) => (
                        <div
                          key={fieldName}
                          className="flex justify-between items-center text-sm mb-1 group relative"
                        >
                          <span className="text-blue-600 truncate max-w-[70%] cursor-help">
                            ...
                            <span className="hidden group-hover:block absolute left-0 top-full mt-1 p-2 bg-gray-800 text-white text-xs rounded shadow-lg z-10 whitespace-normal max-w-[250px]">
                              ...
                              <span className="block mt-1 text-blue-300">
                                Extra charge applied to this service
                              </span>
                            </span>
                          </span>
                          <span className="text-green-600 font-medium">
                    ...
                    {elm.quantity > 1 && (
                      <div className="flex justify-between items-center text-sm pt-1">
                        <span className="text-gray-700 font-medium">
                          Extra charges × {elm.quantity}:
                        </span>
                        <span className="text-green-600 font-medium">
                          +{(totalExtraTax * elm.quantity).toFixed(2)} euro
                        </span>
                      </div>
                    )}
                  </div>
                ...
                {!hasExtraTaxes &&
                  elm.total_price &&
                  elm.service?.base_price &&
                  (() => {
                    const baseTotalPrice =
                      parseFloat(elm.service.base_price) * elm.quantity;
